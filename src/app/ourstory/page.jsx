...
//         <div>
//             <h1>Our Story</h1>
//             <p>Welcome to the Our Story page!</p>
//         </div>
//     );
// }
'use client';
...
import { ChevronRight, Users, Rocket, Lightbulb, History, CheckCircle2, BarChart2 } from 'lucide-react';
...
const OurStory = () => {
    useEffect(() => {
        document.title = 'Our Story | ReKnew';
    }, []);
        ...
        <div className="text-[#374151] w-full min-h-screen overflow-x-hidden font-sans">
            ...
            <section className="py-32 bg-white relative overflow-hidden">
                ...
                <div className="container mx-auto px-6">
                    <motion.div initial="hidden" whileInView="visible" variants={sectionVariants} viewport={{ once: true }} className="max-w-4xl mx-auto">
                        <div className="text-center mb-16">
                            ...
                            <h2 className="text-4xl md:text-5xl font-bold mb-6">
                                ...
                                <span className="relative inline-block">
                                    <span className="relative z-10 text-[#FF512F] pl-2">Enterprise AI</span>
                            ...
                            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                                Over the years, we've transformed countless enterprises through AI-first strategies and innovative solutions.
                            </p>
                        </div>
                        ...
                        <div className="space-y-16">
                            ...
                            <div className="bg-gradient-to-r from-[#FF512F]/5 to-[#FF8A63]/5 rounded-2xl p-8 border border-[#FF512F]/10">
                                <h3 className="text-2xl font-bold mb-4 text-[#374151]">Our story began with a simple realization</h3>
                                <p className="text-xl text-gray-600 mb-8">
                                    Enterprises struggle to keep pace with technological advancements. While AI and automation were revolutionizing industries,
                                    many businesses were still grappling with outdated systems, siloed data, and inefficient workflows.
                                </p>

                                <h4 className="text-xl font-bold mb-4 text-[#374151]">
                                    ReKnew was founded to bridge this gap, creating AI-powered solutions that:
                                </h4>
                    ...
                    <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} className="max-w-6xl mx-auto">
                        <div className="text-center mb-16">
                            <motion.div
                                ...
                                <span className="bg-gradient-to-r from-[#FF512F] to-[#FF8A63] bg-clip-text text-transparent font-medium">About Us</span>
                            </motion.div>
                            <h2 className="text-4xl md:text-5xl font-bold mb-6">
                                Who
                                <span className="relative inline-block">
                                    <span className="relative z-10 text-[#FF512F] pl-2">We Are</span>
                                    <svg className="absolute -bottom-2 left-0 w-full" height="10" viewBox="0 0 100 10" preserveAspectRatio="none">
                                        <path d="M0 5c30-5 70-5 100 0" stroke="#FF512F" strokeWidth="2" fill="none" className="transition-all duration-300" />
                                    </svg>
                                </span>
                            ...
                            <p className="text-xl text-gray-600 max-w-2xl mx-auto">More than just a technology company—we are architects of transformation</p>
                        </div>
                    ...
                    <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} className="max-w-6xl mx-auto">
                        <div className="text-center mb-20">
                            <motion.div
                                ...
                                <span className="bg-gradient-to-r from-[#FF512F] to-[#FF8A63] bg-clip-text text-transparent font-medium">Our Core Values</span>
                            </motion.div>
                            <h2 className="text-4xl md:text-5xl font-bold mb-6">
                                What
                                {/* <span className="text-highlight">Drives Us</span> Forward */}
                                <span className="relative inline-block">
                                    <span className="relative z-10 text-[#FF512F] px-2">Drives Us</span>
                                    <svg className="absolute -bottom-2 left-0 w-full" height="10" viewBox="0 0 100 10" preserveAspectRatio="none">
                                        <path d="M0 5c30-5 70-5 100 0" stroke="#FF512F" strokeWidth="2" fill="none" className="transition-all duration-300" />
                                    </svg>
                                </span>
                            ...
                            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                                Our commitment to innovation and excellence shapes everything we do, driving transformative outcomes for our clients.
                            </p>
                        </div>
                            ...
                            {[
                                {
                                    ...
                                    description: "We don't just solve today's problems—we future-proof your business with AI-driven transformation strategies.",
                                    icon: Rocket,
                                    stat: '2.5x',
                                ...
                                },
                                {
                                    ...
                                    description: 'Transform fragmented data into actionable insights, fueling smarter decision-making and sustainable growth.',
                                    icon: BarChart2,
                                    stat: '99%',
            ...
            <section className="py-24 relative overflow-hidden">
                ...
                <div className="container mx-auto px-6 relative z-10">
                    <motion.div initial="hidden" whileInView="visible" variants={sectionVariants} viewport={{ once: true }} className="max-w-6xl mx-auto">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                            ...
                            <div className="space-y-6">
                                <div className="inline-flex items-center px-6 py-2 rounded-full bg-gradient-to-r from-[#FF512F]/10 to-[#FF8A63]/10 border border-[#FF512F]/20">
                                    ...
                                    <span className="bg-gradient-to-r from-[#FF512F] to-[#FF8A63] bg-clip-text text-transparent font-medium">Our Mission</span>
                                </div>
                                ...
                                <p className="text-xl text-gray-600 leading-relaxed">
                                    To empower enterprises by optimizing workflows, unifying data, and integrating AI-driven solutions, enabling them to make
                                    intelligent, data-backed decisions that fuel growth and innovation.
                                </p>
                            </div>
                            ...
                            <div className="space-y-6">
                                <div className="inline-flex items-center px-6 py-2 rounded-full bg-gradient-to-r from-[#FF512F]/10 to-[#FF8A63]/10 border border-[#FF512F]/20">
                                    ...
                                    <span className="bg-gradient-to-r from-[#FF512F] to-[#FF8A63] bg-clip-text text-transparent font-medium">Our Vision</span>
                                </div>
                                <h2 className="text-4xl font-bold text-[#374151]">
                                    Shaping the
                                    <span className="relative inline-block">
                                ...
                                <div className="space-y-4 text-xl text-gray-600 leading-relaxed">
                                    <p>
                                        We envision a future where businesses operate with seamless intelligence, connecting their core functions, people, and
                                        technology to drive efficiency and maximize potential.
                                    </p>
                                    <p>
                                        ReKnew aims to be the bridge between legacy business models and AI-powered enterprises, fostering agility, intelligence,
                                        and resilience.
                                    </p>
                                </div>
                            </div>
