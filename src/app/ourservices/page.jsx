...
const gradientText1 = (
    <>
        Organizations <span className="font-bold text-[20px] text-[#374151] px-1 flex-shrink-0">struggle to modernize</span> and re-engineer their businesses,
        products, processes and meet their customer demands.
    </>
);
const gradientText2 = (
    <>
        <span className="font-bold text-[20px] text-[#374151] px-1 flex-shrink-0"> Data is siloed and locked</span> in warehouses and systems where use and
        value is limited
    </>
);
const gradientText3 = (
    <>
        The work done and the way we <span className="font-bold text-[20px] text-[#374151] px-1 flex-shrink-0"> work is highly</span> manual. In regulated
        industries, the burden of compliance adds layers of mandatory manual work
    </>
);
const gradientText4 = (
    <>
        <span className="font-bold text-[20px] text-[#374151] px-1 flex-shrink-0"> Skills are lacking </span> to create the future and future proof the business
    </>
);
    ...
    const services = [
        {
          ...
          description: 'Transform your legacy systems with modern data architecture utilizing DATA MESH, DATA FABRIC, and LAKEHOUSE approaches.',
          details: [
        ...
        },
        {
          ...
          description: 'Leverage cognitive intelligence to transform historical data into actionable insights through advanced analytics.',
          details: [
        ...
        },
        {
          ...
          description: 'Build a robust foundation for data monetization while ensuring compliance and data quality.',
          details: [
        ...
        },
        {
          ...
          description: 'Empower your teams with intuitive self-service analytics using No-Code/Low-Code solutions.',
          details: [
        ...
        },
        {
          ...
          description: 'Unified solution for managing critical business data across domains - from customer to product information.',
          details: [
            'Multi-Domain MDM',
        ...
        },
        {
          ...
          description: 'Unlock hidden relationships in your data with advanced graph analytics and visualization.',
          details: [
            'Customer 360° View',
        ...
        },
        {
          ...
          description: 'Modernize your digital infrastructure with microservices and cutting-edge front-end architecture.',
          details: [
            'Modern UI/UX Design',
        ...
        },
        {
          ...
          description: 'Accelerate innovation with state-of-the-art generative AI technologies and frameworks.',
          details: [
            'Custom AI Models',
    ...
    const starterPack = {
        foundations: [
            {
                ...
                description: 'A fine-tuned Language Model grounded on a target domain (ex: Banking) that is more reliable than general purpose LLMs.',
                details: 'Carefully curated and validated domain datasets provide transparency.'
            },
            {
                ...
                details: 'Configurable and enrichable with Enterprise-specific knowledge.'
            },
            {
        ...
        solution: [
            ...
            },
            {
                ...
                details: 'Pluggable and easily integrated into existing digital solutions.'
            }
        ],
        uitility: [
            {
                title: 'Synthetic Data Generator',
                description: 'A utility to generate synthetic data to enable AI-based models and applications.',
    ...
    return (
        <div className="text-[#374151] w-full min-h-screen overflow-x-hidden font-sans">
                    ...
                    <div initial={{ opacity: 0, y: 20 }}  viewport={{ once: true }} className="text-center mb-16">
                        ...
                        <h2 className="text-4xl md:text-5xl font-bold mb-6 text-[#374151]">
                            ...
                            <span className="relative inline-block">
                                <span className="relative z-10 text-[#FF512F] pl-2">Offerings</span>
                        ...
                        <p className="text-xl text-[#374151] max-w-3xl mx-auto">
                            End-to-end AI-driven transformation solutions across multiple industries. We help modernize legacy systems, automate workflows, and
            ...
            <div className="flex flex-col justify-center items-center px-4 md:px-8 lg:px-12 md:py-[100px] bg-gradient-to-br from-[#FFF8F6] via-white to-[#FFF4F0] relative overflow-hidden">
                ...
                <div className="relative flex flex-col max-w-7xl items-center z-10">
                    <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-16">
                        <div className="inline-flex items-center px-6 py-2 rounded-full bg-gradient-to-r from-[#FF512F]/10 to-[#FF8A63]/10 border border-[#FF512F]/20 mb-6">
                            <span className="bg-gradient-to-r from-[#FF512F] to-[#FF8A63] bg-clip-text text-transparent font-medium">Industry Expertise</span>
                        </div>
                        <h1 className="text-3xl md:text-[44px] text-[#374151] font-medium mb-4">
                            {/* <span className="text-highlight">Industries</span> */}
                            <span className="relative inline-block">
                                <span className="relative z-10 text-[#FF512F] pr-2">Industries</span>
                                <svg className="absolute -bottom-2 left-0 w-full" height="10" viewBox="0 0 100 10" preserveAspectRatio="none">
                                    <path d="M0 5c30-5 70-5 100 0" stroke="#FF512F" strokeWidth="2" fill="none" className="transition-all duration-300" />
                                </svg>
                            </span>
                        ...
                        <p className="text-[#374151] text-lg max-w-4xl mx-auto">
                            We empower businesses across various industries with cutting-edge AI solutions to innovate, scale, and thrive in the digital era
                        </p>
                    </motion.div>
                        ...
                        {[
                            {
                                ...
                                features: [
                                    { icon: <Brain size={20} />, text: 'AI-powered diagnostic assistance' },
                                    { icon: <Users size={20} />, text: 'Patient journey optimization' },
                                    { icon: <LineChart size={20} />, text: 'Clinical trial analytics' }
                                ]
                            },
                            {
                                ...
                                features: [
                                    { icon: <Shield size={20} />, text: 'Risk assessment automation' },
                                    { icon: <Database size={20} />, text: 'Fraud detection systems' },
                                    { icon: <BarChart3 size={20} />, text: 'Algorithmic trading solutions' }
                                ]
                            },
                            {
                                ...
                                features: [
                                    { icon: <Users size={20} />, text: 'Customer behavior analytics' },
                                    { icon: <Zap size={20} />, text: 'Inventory optimization' },
                                    { icon: <LineChart size={20} />, text: 'Personalized recommendations' }
                                ]
                            },
                            {
                            ...
                            },
                            {
                                ...
                                title: 'Insurance',
                                features: [
                                    { icon: <Shield size={20} />, text: 'Claims processing automation' },
                                    { icon: <Database size={20} />, text: 'Risk assessment models' },
                                    { icon: <Users size={20} />, text: 'Customer service optimization' }
                                ]
                            },
                            {
                                ...
                                features: [
                                    ...
                                    { icon: <LineChart size={20} />, text: 'Quality control automation' },
                                    { icon: <BarChart3 size={20} />, text: 'Production optimization' }
                                ]
                            }
            ...
            <div className="py-[100px] bg-gradient-to-br from-[#FFF8F6] via-white to-[#FFF4F0] p-4 sm:p-8 relative overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto relative">
                    <motion.div
                        ...
                        <div className="inline-flex items-center px-6 py-2 rounded-full bg-gradient-to-r from-[#FF512F]/10 to-[#FF8A63]/10 border border-[#FF512F]/20 mb-6">
                            <span className="bg-gradient-to-r from-[#FF512F] to-[#FF8A63] bg-clip-text text-transparent font-medium">Our Approach</span>
                        </div>
                        <h1 className="text-3xl sm:text-4xl font-medium text-[#374151] mb-4">
                            A Typical Three-Part
                            <span className="relative inline-block">
                                <span className="relative z-10 text-[#FF512F] pl-2">Journey</span>
                                <svg className="absolute -bottom-2 left-0 w-full" height="10" viewBox="0 0 100 10" preserveAspectRatio="none">
                                    <path d="M0 5c30-5 70-5 100 0" stroke="#FF512F" strokeWidth="2" fill="none" className="transition-all duration-300" />
                                </svg>
                            </span>
                        ...
                        <p className="text-lg md:text-xl text-[#374151] max-w-3xl mx-auto">
                            Our systematic approach to enterprise modernization ensures a smooth transition and successful implementation
                        </p>
                    </motion.div>
                                        ...
                                        <div className="flex items-center gap-4 mb-6">
                                            <div className="relative">
                                                ...
                                                <div
                                                    ...
                                                    <Image src={item.icon} alt={item.phase} className="w-12 h-12" />
                                                </div>
                                            </div>
                                            <h3
                ...
                <div className="container mx-auto px-4 relative z-10">
                    ...
                    <motion.div
                        ...
                        <h2 className="text-4xl md:text-5xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-[#374151] to-[#374151]/80">
                            ReKnew
                            <span className="relative inline-block">
                                <span className="relative z-10 text-[#FF512F] pl-2">Starter Pack</span>
                                <svg className="absolute -bottom-2 left-0 w-full" height="10" viewBox="0 0 100 10" preserveAspectRatio="none">
                                    <path d="M0 5c30-5 70-5 100 0" stroke="#FF512F" strokeWidth="2" fill="none" className="transition-all duration-300" />
                                </svg>
                            </span>
                        ...
                        Starter Packs help Enterprises accelerate their initiatives by providing well-defined, configurable and deployable assets. They help
                        Enterprises go from 0 to v0.5 with minimal effort, providing a framework to deliver the first MVP and v1.0.
                        </p>
                    </motion.div>
                                ...
                                <div
                                    ...
                                    <div className="flex items-start gap-4 mb-8">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-[#374151]/70 mt-1">{layer.description}</p>
                                        </div>
                                    </div>
                                        ...
                                        {layer.items.map((item, idx) => (
                                            <motion.div
                                                ...
                                                <div className="space-y-3">
                                                    ...
                                                    <div className="text-xs text-[#374151]/60 
            ...
            <motion.section
                ...
                <div className="max-w-7xl mx-auto relative">
                    ...
                    <motion.div
                        ...
                        <div className="inline-flex items-center px-6 py-2 rounded-full bg-gradient-to-r from-[#FF512F]/10 to-[#FF8A63]/10 border border-[#FF512F]/20 mb-6">
                            <span className="bg-gradient-to-r from-[#FF512F] to-[#FF8A63] bg-clip-text text-transparent font-medium">Current Challenges</span>
                        </div>
                        <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-6">
                            ...
                            <span className="relative inline-block">
                                <span className="relative z-10 text-[#FF512F] pl-2">Future</span>
                                <svg className="absolute -bottom-2 left-0 w-full" height="10" viewBox="0 0 100 10" preserveAspectRatio="none">
                                    <path d="M0 5c30-5 70-5 100 0" stroke="#FF512F" strokeWidth="2" fill="none" className="transition-all duration-300" />
                                </svg>
                            </span>
                    ...
                    <motion.div
                        ...
                        <h2 className="text-3xl sm:text-4xl font-bold bg-gradient-to-r from-[#374151] to-[#374151]/80 bg-clip-text text-transparent">
                            ...
                            <span className="text-highlight block mt-2">AI-driven flywheels?</span>
                        </h2>
                    </motion.div>
                </div>
            </motion.section>
           ...
           <Flywheel />
            ...
            <motion.div whileInView={{ opacity: [0, 1], y: [50, 0] }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
