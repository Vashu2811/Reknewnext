...
// SSR function to determine dark mode (example: based on cookies or headers)
export async function getServerSideProps(context) {
    // Example: check cookie for theme, fallback to false
    const isDarkMode = context.req.cookies?.theme === 'dark' || false;
    return { props: { isDarkMode } };
}

const OurStory = ({ isDarkMode }) => {
    return (
        <>
