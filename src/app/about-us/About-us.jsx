...
class OurStory extends React.Component {
    ...
    render() {
        const { isDarkMode, isModalOpen } = this.state;
        return (
            <>
                <Head>
                    <title>About-us | ReKnew</title>
                    <meta name="description" content="Learn more about ReKnew—our mission, our values, and how we empower better business transformation." />
                    <meta property="og:title" content="About-us | ReKnew" />
                    <meta property="og:description" content="Learn more about ReKnew—our mission, our values, and how we empower better business transformation." />
                    <meta property="og:type" content="website" />
                    <meta property="og:url" content="https://reknew.ai/about-us" />
                    <meta property="og:image" content="https://opengraph.b-cdn.net/production/images/7b51162a-d886-4727-b920-6942b1bce177.jpg?token=h6uIKapL9RvEAZTxnfwWQiFT-B-wXH55jnK67eFe54o&height=800&width=1200&expires=33287797796" />
                    <meta name="twitter:card" content="summary_large_image" />
                    <meta name="twitter:title" content="About-us | ReKnew" />
                    <meta name="twitter:description" content="Learn more about ReKnew—our mission, our values, and how we empower better business transformation." />
                    <meta name="twitter:image" content="https://opengraph.b-cdn.net/production/images/7b51162a-d886-4727-b920-6942b1bce177.jpg?token=h6uIKapL9RvEAZTxnfwWQiFT-B-wXH55jnK67eFe54o&height=800&width=1200&expires=33287797796" />
                    <link rel="canonical" href="https://reknew.ai/about-us" />
                </Head>
                <div className="text-[#374151] dark:text-gray-100 font-sans w-full min-h-screen overflow-x-hidden">
                    <HiringModel isOpen={isModalOpen} onClose={this.closeModal} isDarkMode={isDarkMode} />
                    ...
                    <CareerOpportunities openHiringModal={this.openModal} isDarkMode={isDarkMode} />
