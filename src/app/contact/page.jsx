...
const ContectUs = () => {
  ...
  const gradientText = (
    <div className="text-[#232323]">
      Let’s Transform Your <span className="text-highlight pr-2">Business</span>
      with AI
    </div>
  );
          ...
          <div className="container mx-auto px-6">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl text-gray-600 mb-8">
                Connect with ReKnew's AI experts to transform your business
                vision into reality
              </p>
            </div>
          </div>
                    ...
                    {[
                      ...
                      >
                        ...
                        <div className="relative flex-shrink-0">
                          <div
                            className={`absolute inset-0 bg-gradient-to-br ${item.gradient} rounded-xl blur-xl`}
                          ></div>
                          <span
                  ...
                  >
                    ...
                    <div className="relative">
                      ...
                      <div className="mt-4 flex items-start gap-2 text-sm text-[#666666]">
                        ...
                        <p>
                          Holiday schedules may vary. Please contact us for
              ...
              <div className="flex flex-col gap-8 text-left max-w-xl">
                ...
                <div className="space-y-8">
                  <p className="text-lg leading-[160%] text-[#666666]">
                    Join industry leaders who have achieved transformative
                    results with our enterprise AI solutions. Experience the
                    power of:
                  </p>
