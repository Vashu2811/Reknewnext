        ...
        <div className="min-h-screen bg-white dark:bg-gray-900 flex flex-col">
            <main className="flex-grow">
                <div className="dark:bg-gray-900 mt-20">
                    <Container>
                        <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 mb-4 dark:text-gray-300">Terms and Conditions</h1>
                ...
                <Container className="pt-12">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
                                {[
                                    ...
                                    <button
                                        ...
                                        className="  w-full text-left px-3 py-2 text-sm rounded-md dark:hover:bg-gray-800 hover:bg-gray-100 dark:text-gray-300 text-gray-700 hover:text-[#FF512F] dark:hover:text-[#FF512F] transition-colors duration-200">
                                        {item.label}
                                    </button>
                                ))}
                            </div>
                    ...
                    <div className="lg:col-span-3">
                        <PolicySection id="Agreement" title="1. Agreement-to-terms" defaultOpen={true}>
                            ...
                            <p className="dark:text-gray-300">If you do not agree with any part of these Terms, please do not access or use the Site.</p>
                        </PolicySection>
                        ...
                        <PolicySection id="Permitted" title="4. Permitted Use">
                            <h3 className="text-lg font-semibold text-gray-800 mb-2 dark:text-gray-300">You may use the Site only for:</h3>
                            ...
                            <h3 className="text-lg font-semibold text-gray-800 mb-2 dark:text-gray-300">You agree not to:</h3>
                            <ul className="list-disc pl-6 mb-4 dark:text-gray-300 space-y-2">
                        ...
                        <PolicySection id="Limitation" title="6. Limitation of Liability">
                            ...
                            <p className="dark:text-gray-300">ReKnew’s total cumulative liability shall not exceed USD 100.</p>
                        </PolicySection>
