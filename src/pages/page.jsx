...
const words = ["AutoPilot", "ReImagined", "Revitalized"];
...
export default function Home() {
  ...
  const services = [
    ...
    },
    {
      ...
      details: [
        ...
        "Reduce operational costs with AI-driven process improvements.",
      ],
      img: workflowImage,
    },
    {
      ...
      details: [
        "Consolidate fragmented data into a structured ecosystem.",
        "Improve data accessibility and enhance decision-making.",
      ],
      img: dataIntegrationImage,
    },
    {
      id: 4,
  ...
  const servicesOffring = (
    <div className="w-[350px] md:w-[500px] xl:w-[648px] ">
      <Image
    ...
    <>
      <div className="back-background text-white font-montserrat w-full min-h-screen">
        <div className="">
          ...
          <motion.section className="w-full lg:min-h-screen md:h-[760px] h-[550px] flex justify-center items-center text-center">
            <div className="flex flex-col w-[1280px] gap-9">
              <div className="flex text-[28px] sm:text-[28px] md:text-[50px]  font-normal justify-center  lg:text-[87px] leading-[120%] tracking-[0]  ">
                {/* <span>
        {" "}
        ...
        Business Operates
                ...
                >
                  <div className="flex flex-wrap justify-center">
                    <span className="">Your Business on</span>

                     <AnimatePresence mode="wait">
                      <motion.span
                        key={words[index]}
                        className="backgroundImage md:w-[250px] lg:w-[550px] flex justify-center"
      ...
      >
        <div className="face face1">AutoPilot</div>
        <div className="face face2">ReImagined</div>
        <div className="face face3">Revitalized</div>
      </motion.div>
    </div> */}
                    {/* <span className="">Your Business on</span> */}
                  </div>
          ...
          <span className="">Business Operates</span>
              ...
              >
                <p className="md:px-8 sm:px-8  px-8 lg:px-72 text-[14px] md:text-[20px]  lg:text-[20px] font-normal text-gray-300  text-center">
                  We help enterprises re-engineer the flywheels with Data, AI,
                  Workflows, Connectorsto reduce inefficiencies and unlock
                  growth oppourtunities
                </p>
              </motion.div>
              <motion.div
                viewport={{ once: false, amount: 0.2 }}
              ...
              >
                <div className="flex flex-col md:flex-row justify-center space-y-4 md:space-y-0 md:space-x-4">
                  ...
                  <button className="light px-4 h-[46px] text-[#FFFFFF] py-2 font-semibold rounded-md border border-[#606060] hover:bg-gray-800 transition-colors flex items-center justify-center tracking-wide">
                    Book a Consultation
                    <ArrowRight className="ml-2 h-5 w-5" />
                  </button>
                </div>
        ...
        <motion.div
          viewport={{ once: false, amount: 0.2 }}
          initial={{ opacity: 0, xy: 50, scale: 0.8 }}
          whileInView={{ opacity: 1, y: 0, scale: 1 }}
        ...
        <div className="flex md:my-[100px] flex-col justify-center items-center px-4 py-6 md:px-8 lg:px-12 ">
          <div className="flex flex-col  max-w-7xl items-center ">
            ...
            >
              ...
              <button className=" light h-[46px] border border-[#606060]  text-white font-semibold py-2 px-6 rounded-md inline-flex items-center transition-all duration-300">
            ...
            <div className="flex flex-col lg:flex-row w-[360px] md:w-[730px] lg:w-[950px] xl:w-[1280px] lg:gap-8 xl:gap-[52px]">
              ...
              >
                {services.map((item, i) => (
                  ...
                  >
                    <div
                      className={`flex flex-col w-full gap-[18px] items-start justify-start md:text-left cursor-pointer ${
                    ...
                    >
                        ...
                        <span
                          className={`${
                            item.id === activeService
                              ? "bg-[#665EE9]"
                              : "bg-[#828282]"
                          } h-[30px] transition-all w-[6px] flex-shrink-0`}
                          style={{
                            clipPath:
                              "polygon(0 0, 100% 34%, 100% 100%, 0 66%)",
                          }}
                        ></span>
                      ...
                      <ul
                        className={`flex flex-col list-disc pl-5 font-normal text-base leading-[140%] tracking-[0%] gap-2 `}
                      >
                    ...
                    {services.length - 1 > i ? (
                      <div
                        className={`flex flex-ror w-full h-[1px] ${
                          item.id === activeService
                            ? "bg-white"
                            : "bg-[#828282]"
                        }`}
                    ...
                    {item.id === activeService && (
                      <div className="flex lg:hidden justify-center md:justify-start">
                        {servicesOffring}
                      </div>
                    )}
                  </div>
              ...
              <motion.div
                ...
                whileInView={{ opacity: 1, x: 0, scale: 1 }}
                transition={{ duration: 1, ease: "easeOut" }}
                className="hidden lg:flex  justify-center md:justify-start"
              >
                {servicesOffring}
              </motion.div>
            </div>
        ...
        >
          <div className="container mx-auto px-4 py-16 md:py-20 lg:py-[100px]">
                ...
                {[
                  ...
                  >
                    <div className="flex absolute w-full h-full z-20 ">
                      <motion.div
                        className="flex absolute w-full h-full z-20"
                        animate={{
                          scale: [1, 1.05, 1],
                          rotate: [0, 10, -10, 0],
                          opacity: [0.8, 1, 0.8],
            ...
            <div className="flex justify-center">
              <button className="box px-4 h-[46px] text-[#FFFFFF] py-2 font-semibold rounded-md border border-[#606060] hover:bg-gray-800 transition-colors flex items-center justify-center tracking-wide">
        ...
        <div className=" flex flex-col  justify-center items-center px-4 py-6 md:px-8 lg:px-12 md:py-[100px]">
          {/* <div
            className="text-center mb-12 md:mb-[52px]"
          > */}
          <motion.div
           viewport={{ once: false, amount: 0.2 }}
           whileInView={{ opacity: 1, y: 0, scale: 1 }}
          ...
          >
           ...
           whileInView={{ opacity: 1, y: 0, scale: 1 }}
                  ...
                  transition={{
                    duration: 0.9,
                    ease: "easeInOut",
                  }} className="hidden md:block absolute top-8 left-[15%] right-[15%]">
          ...
          <div className="flex justify-center mt-12">
            <button className="box h-[46px] border border-gray-700  text-white font-medium py-2 px-6 rounded-md inline-flex items-center transition-all duration-300">
        ...
        <div ref={containerRef}>
          <Consultation
            title={gradientText}
            tag_one="Get in touch with us to see how we can help your enterprise scale, optimize, and thrive."
