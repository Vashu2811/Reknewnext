...
//                   >
//                     <div className={`flex flex-col w-full gap-[18px] items-start justify-start md:text-left cursor-pointer ${item.id === activeService ? 'text-[#ffffff]' : 'text-[#CFD0D3]' }`}
...
//                         </div>
//                       </div>
//                       <ul className={`flex flex-col list-disc pl-5 font-normal text-base leading-[140%] tracking-[0%] gap-2 `}>
...
//                   </div>))}
//                 </div>
//                 <div className="hidden lg:flex  justify-center md:justify-start">{servicesOffring}</div>
//             </div>
//           </div>
//         </div>
