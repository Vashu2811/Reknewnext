...
<Navbar />
        <section className="w-full min-h-screen flex justify-center items-center px-4 text-center">
          <div className="max-w-4xl">
            <p className="text-lg md:text-xl mb-8">The ReKnew Platform</p>
        ...
        <div className="min-h-screen text-white flex flex-col items-center justify-center px-4 md:px-8 lg:px-12">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 md:gap-8 max-w-6xl mx-auto mb-12">
            {[
              ...
              <div key={index} className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="text-lg md:text-xl font-semibold text-[#665EE9] mb-2">
                    {item.title}
                  </h3>
          ...
          <button className="border border-gray-800 hover:bg-indigo-700 text-white font-medium py-3 px-6 rounded-md flex items-center transition-all duration-300 shadow-md">
        ...
        <div className="min-h-screen text-white">
          <header className="container mx-auto px-4 py-8 md:py-12">
            ...
            <p className="text-center mt-4 max-w-3xl mx-auto text-gray-300 text-sm md:text-base">
          ...
          <main className="container mx-auto px-4 py-8">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 mb-4 md:mb-6">
              ...
              >
                ...
                <p className="text-sm text-gray-300 mb-4">
                  Break down data silos and create a unified business
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 mb-8">
              ...
              >
                ...
                <p className="text-sm text-gray-300 mb-4">
                  Enhance customer and employee engagement with AI-driven
                  virtual assistants.
                </p>
                <ul className="space-y-2 text-sm text-gray-300">
                  <li className="flex items-start">
                    <span className="text-indigo-400 mr-2">•</span>
                    <span>24/7 AI-powered customer support bots</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-indigo-400 mr-2">•</span>
              ...
              >
                ...
                <p className="text-sm text-gray-300 mb-4">
                  Protect your business with AI-driven security solutions and
        ...
        <div className="min-h-screen text-white flex flex-col items-center justify-center p-4 md:p-8">
          ...
          <div className="max-w-7xl w-full mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
            <div className="flex justify-center items-center">
              <Image
                src={DigitalEarth}
                alt="Digital technology integration visualization"
                className="rounded-lg object-cover shadow-lg shadow-indigo-500/30"
              />
            </div>
